...
import mmengine.utils as mmutil # mkdir_or_exist, track_progress, track_parallel_progress 모두 mmengine utils 에 존재
...
def main():
    ...
    mmutil.mkdir_or_exist(osp.join(out_mask_dir, 'train2017'))
    mmutil.mkdir_or_exist(osp.join(out_mask_dir, 'val2017'))
    ...
    if args.nproc > 1:
        mmutil.track_parallel_progress(
            partial(
